...
export class GameView extends view {
    ...
    constructor(context) {
        ...
        this.#paddleBallSound = new Sound("./sounds/軽いパンチ1.mp3");
        this.#blockBallSound = new Sound("./sounds/重いパンチ1.mp3");
    }
    ...
    update() {
        ...
        // ボールとパドルの衝突を確認する
        this.#checkCollisoinBallAndPaddle();
        // パドルと壁の衝突を確認する
